<script lang="ts">
	import { Card, Button, Label, Input, Spinner, 		TableBody,
		TableBodyCell,
		TableBodyRow,
		TableHeadCell,
		TableSearch,
		TableHead } from 'flowbite-svelte';
    ...
    let weekday: string, availabilities, users, incidences, userList: number[] = [], skip: boolean = false, brothers: number = 0, sisters: number = 0;
                                    ...
                                    <TableBodyRow>
                                        ...
                                        <TableBodyCell>
                                            <Button
                                                color="blue"
                                                class="mr-2"
                                                id="edit-{turn.id}">{$_('general.edit-btn')}</Button>
                                            <Button
                                                color="red"
                                                class="ml-2"
                                                id="delete-{turn.id}">{$_('general.delete-btn')}</Button>
                                        </TableBodyCell>
                                    </TableBodyRow>
                                {/if}
                            {/each}
