	...
	<ul>
		...
		<li>
			<p>
				...
				in this Agreement) refers to PPOC Gen.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>Website</strong> refers to PPOC Gen, accessible from
				<a href="https://ppocgen.com" rel="external nofollow noopener" target="_blank">https://ppocgen.com</a>
			</p>
		</li>
		<li>
			<p>
